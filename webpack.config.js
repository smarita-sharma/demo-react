...
const THIS_APP_ID = 'bahmni-patient-tagging';
...
var getConfig = function() {
  ...
  try {
    ...
    config = {
      LOCAL_OWA_FOLDER:
        '/home/smarita/openmrs/server/owa/',
      APP_ENTRY_POINT:
        'http://localhost:8081/openmrs/owa/patienttag/public/index.html'
    };
...
let webpackConfig = {
  quiet: false,
  entry: {
    app: `${__dirname}/app/js/bahmni-owa-patient-tagging`,
